...
public class RedisClient {
    ...
    /*<beanidbeanid="jedisPoolConfig"class="redis.clients.jedis.JedisPoolConfig">  
    <propertynamepropertyname="maxIdle"value="${redis.pool.maxIdle}"/>  
    <propertynamepropertyname="maxTotal"value="${redis.pool.maxActive}"/>    
    <propertynamepropertyname="maxWaitMillis"value="${redis.pool.maxWait}"/>   
    <propertynamepropertyname="testOnBorrow"value="${redis.pool.testOnBorrow}"/>  
    <propertynamepropertyname="testOnReturn"value="${redis.pool.testOnReturn}"/>  
</bean>*/
    /**
     * 初始化非切片池
     */
